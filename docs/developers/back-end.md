...
**Nb:** Available services / filters defined in **ov** module are described in the [API](http://veo-labs.github.io/openveo-core/2.0.0/api/back-end/modules/ov.html).
...
**Nb:** Available services defined in **ov.alert** module are described in the [API](http://veo-labs.github.io/openveo-core/2.0.0/api/back-end/modules/ov.alert.html).
...
**Nb:** Available services / filters defined in **ov.authentication** module are described in the [API](http://veo-labs.github.io/openveo-core/2.0.0/api/back-end/modules/ov.authentication.html).

## Entity module (**ov.entity**)

Offers a service to manage (CRUD) OpenVeo entities described in [conf.js](/developers/conf).

**Nb:** Available services defined in **ov.entity** module are described in the [API](http://veo-labs.github.io/openveo-core/2.0.0/api/back-end/modules/ov.entity.html).
...
**Nb:** Available services / filters defined in **ov.i18n** module are described in the [API](http://veo-labs.github.io/openveo-core/2.0.0/api/back-end/modules/ov.i18n.html).

## Storage module (**ov.storage**)

Offers a service to manipulate the local storage.

**Nb:** Available services defined in **ov.storage** module are described in the [API](http://veo-labs.github.io/openveo-core/2.0.0/api/back-end/modules/ov.storage.html).
